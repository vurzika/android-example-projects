...
// add compile dependency in gradle:
...
public class ChangeTextBehaviorTest {
     ...
     */
    // Register IdlingResource before the test is run
    // All that happens in @Before block happens after the Main Activity is created.
    @Before
    ...
    // Unregister IdlingResource after the test is run
    @After
