...
//    }
    ...
    @Test
    public void powNegFirstNumber() {
        double resultPow = mCalculator.pow(-4d, 2d);
        assertThat(resultPow, is(equalTo(16d)));
    }

    @Test
    public void powNegSecondNumber() {
        double resultPow = mCalculator.pow(4d, -2d);
