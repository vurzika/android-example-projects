...
public class DialerActivityTest {
    ...
    // This test mocks typing a phone number into the EditText field in the DialerActivity and verifies
    // that the intent to the dialer was sent with the correct information (action, phone number, and package).
    @Test
    ...
    // Intent Stubbing test

    // This test stubs the intent that is sent when the user clicks the "Contact Button"
    // by passing a hard-coded phone number, VALID_PHONE_NUMBER
    @Test
